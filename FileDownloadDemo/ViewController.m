...
-(void)layoutUI{
    ...
    _textField.text=@"master.zip";
    [self.view addSubview:_textField];
    //进度条
    _progressView=[[UIProgressView alloc]initWithFrame:CGRectMake(10, 100, 200, 25)];
    ...
    //下载按钮
    _button=[[UIButton alloc]initWithFrame:CGRectMake(10, 300, 300, 25)];
...
-(void)sendRequest{
    ...
    NSString *urlStr=[NSString stringWithFormat:@"https://github.com/cnbin/insertDemo/archive/%@",_textField.text];
